    ...
    internal class Program
    {
        ...
        private static List<string> createArrayToPrint(ushort[] currentHoursMapping, double[] volumesAggregate, DateTime currentDatetime)
        {
            ...
            foreach (double volume in volumesAggregate)
            {
                ...
                {
                    currentHour++;
                    lines.Add(currentHour.ToString() + " write in current day;" + volume.ToString() + ";");
                    currentDayCounter++;
                    flowControl = true;
                }
                ...
                {
                    lines.Add(currentHour.ToString() + "write in day ahead;" + volume.ToString() + ";");
                    currentHour++;
                    dayAheadCounter++;
                }
            }
        ...
        private static ushort[][] definehoursMapping()
        {
            ...
            ushort[][] result = [ zero, one, two, three, four, five, six, seven, eight, nine, ten, eleven, twelve,
        ...
        private static void writeCsv(string outputPath, List<string> lines)
        {
            string docPath =
